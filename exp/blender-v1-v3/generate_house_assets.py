...
def expand_paint_assets() -> list[dict]:
    variants = []
    for family in PAINT_CATALOG["families"]:
        overrides = family.get("id_overrides", {})
        for tone in PAINT_CATALOG["tones"]:
            for finish in PAINT_CATALOG["finishes"]:
                variant_key = f"{tone['id']}_{finish['id']}"
                asset_id = overrides.get(
                    variant_key,
                    f"paint_{family['id']}_{tone['id']}_{finish['id']}_01",
                )
                variants.append(
                    {
                        "id": asset_id,
                        "name": f"{family['name_en']} {tone['name_en']} {finish['name_en']} wall paint",
                        "name_zh": f"{family['name_zh']} · {tone['name_zh']} · {finish['name_zh']}墙漆",
                        "category": "wall_paint",
                        "representation": "parametric_material",
                        "family_id": family["id"],
                        "tone": tone["id"],
                        "finish": finish["id"],
...
WALL_FACES = [
    ...
    {"id": "wall_face_001", "code": "LIV-S", "name_zh": "客厅南墙", "room_id": "living_room", "orientation": "south", "host_wall_id": "wall_exterior_south", "axis": "X", "coordinate": 0.1005, "start": 0.10, "end": 4.10, "asset_id": "paint_warm_cream_matte_01", "preview_hide": True},
    ...
    {"id": "wall_face_003", "code": "LIV-N", "name_zh": "客厅北墙", "room_id": "living_room", "orientation": "north", "host_wall_id": "wall_bedrooms_south", "axis": "X", "coordinate": 4.5995, "start": 0.20, "end": 4.10, "asset_id": "paint_warm_cream_matte_01"},
    {"id": "wall_face_004", "code": "DIN-S", "name_zh": "餐厅南墙", "room_id": "dining_room", "orientation": "south", "host_wall_id": "wall_exterior_south", "axis": "X", "coordinate": 0.1005, "start": 4.10, "end": 6.60, "asset_id": "paint_warm_cream_matte_01", "preview_hide": True},
    {"id": "wall_face_005", "code": "DIN-E", "name_zh": "餐厅东墙", "room_id": "dining_room", "orientation": "east", "host_wall_id": "wall_central_spine", "axis": "Y", "coordinate": 6.5995, "start": 0.20, "end": 4.60, "asset_id": "paint_warm_cream_matte_01"},
    {"id": "wall_face_006", "code": "DIN-N", "name_zh": "餐厅北墙", "room_id": "dining_room", "orientation": "north", "host_wall_id": "wall_bedrooms_south", "axis": "X", "coordinate": 4.5995, "start": 4.10, "end": 6.60, "asset_id": "paint_warm_cream_matte_01"},
    {"id": "wall_face_007", "code": "MBR-N", "name_zh": "主卧北墙", "room_id": "master_bedroom", "orientation": "north", "host_wall_id": "wall_exterior_north", "axis": "X", "coordinate": 8.2995, "start": 0.10, "end": 3.80, "asset_id": "paint_light_greige_eggshell_01"},
    {"id": "wall_face_008", "code": "MBR-E", "name_zh": "主卧东墙", "room_id": "master_bedroom", "orientation": "east", "host_wall_id": "wall_between_bedrooms", "axis": "Y", "coordinate": 3.7995, "start": 4.72, "end": 8.30, "asset_id": "paint_light_greige_eggshell_01"},
    {"id": "wall_face_009", "code": "MBR-S", "name_zh": "主卧南墙", "room_id": "master_bedroom", "orientation": "south", "host_wall_id": "wall_bedrooms_south", "axis": "X", "coordinate": 4.7205, "start": 0.20, "end": 3.80, "asset_id": "paint_light_greige_eggshell_01"},
    {"id": "wall_face_010", "code": "MBR-W", "name_zh": "主卧西墙", "room_id": "master_bedroom", "orientation": "west", "host_wall_id": "wall_exterior_west", "axis": "Y", "coordinate": 0.1005, "start": 4.72, "end": 8.30, "asset_id": "paint_light_greige_eggshell_01"},
    ...
    {"id": "wall_face_012", "code": "BR2-E", "name_zh": "次卧东墙", "room_id": "bedroom_2", "orientation": "east", "host_wall_id": "wall_central_spine", "axis": "Y", "coordinate": 6.5995, "start": 4.72, "end": 8.20, "asset_id": "paint_light_greige_eggshell_01"},
    {"id": "wall_face_013", "code": "BR2-S", "name_zh": "次卧南墙", "room_id": "bedroom_2", "orientation": "south", "host_wall_id": "wall_bedrooms_south", "axis": "X", "coordinate": 4.7205, "start": 3.92, "end": 6.60, "asset_id": "paint_light_greige_eggshell_01"},
    {"id": "wall_face_014", "code": "BR2-W", "name_zh": "次卧西墙", "room_id": "bedroom_2", "orientation": "west", "host_wall_id": "wall_between_bedrooms", "axis": "Y", "coordinate": 3.9205, "start": 4.72, "end": 8.30, "asset_id": "paint_light_greige_eggshell_01"},
    ...
    {"id": "wall_face_019", "code": "FOY-S", "name_zh": "玄关走廊南墙", "room_id": "foyer_corridor", "orientation": "south", "host_wall_id": "wall_kitchen_north", "axis": "X", "coordinate": 2.9005, "start": 6.72, "end": 10.70, "asset_id": "paint_warm_cream_matte_01"},
    {"id": "wall_face_020", "code": "FOY-E", "name_zh": "玄关走廊东墙", "room_id": "foyer_corridor", "orientation": "east", "host_wall_id": "wall_exterior_east", "axis": "Y", "coordinate": 10.6995, "start": 2.90, "end": 4.60, "asset_id": "paint_warm_cream_matte_01", "preview_hide": True},
    {"id": "wall_face_021", "code": "FOY-N", "name_zh": "玄关走廊北墙", "room_id": "foyer_corridor", "orientation": "north", "host_wall_id": "wall_service_south", "axis": "X", "coordinate": 4.5995, "start": 6.72, "end": 10.70, "asset_id": "paint_warm_cream_matte_01"},
    {"id": "wall_face_022", "code": "FOY-W", "name_zh": "玄关走廊西墙", "room_id": "foyer_corridor", "orientation": "west", "host_wall_id": "wall_central_spine", "axis": "Y", "coordinate": 6.7205, "start": 2.90, "end": 4.60, "asset_id": "paint_warm_cream_matte_01"},
...
def make_paint_material(asset: dict) -> bpy.types.Material:
    ...
    material["paint_family_id"] = asset["family_id"]
    ...
    # Object coordinates are metric after transform application; two repeats per
    # metre match the catalog's 0.5 m physical texture tile.
    mapping.inputs["Scale"].default_value = (2.0, 2.0, 2.0)
    links.new(texcoord.outputs["Object"], mapping.inputs["Vector"])

    base_texture = nodes.new("ShaderNodeTexImage")
    base_texture.name = "Paint micro base colour"
    base_texture.image = load_paint_image("paint_micro_basecolor_4k.jpg", "sRGB")
    ...
    normal_texture.image = load_paint_image("paint_micro_normal_gl_4k.jpg", "Non-Color")
...
def make_wallpaper_material(asset: dict) -> bpy.types.Material:
    ...
    material["wallpaper_family"] = asset["family"]
...
def make_surface_pbr_material(asset: dict) -> bpy.types.Material:
    ...
    material["surface_family"] = asset["family"]
    material["repeat_size_m"] = asset["repeat_size_m"]
...
def build_asset_catalog(collection: bpy.types.Collection, materials: dict[str, bpy.types.Material]) -> None:
    ...
    # Six-column catalog for eight wallpapers, six floors and eight tiles.
    add_box("Catalog_Backdrop", (13.6, 0.12, 8.2), (18.0, 0.35, 3.35), collection, materials["catalog_base"])
...
def build_paint_catalog(collection: bpy.types.Collection, materials: dict[str, bpy.types.Material]) -> None:
    """Build a six-column by ten-family physical paint study wall."""
    center_x = 18.0
    add_box("PaintCatalog_Backdrop", (11.2, 0.12, 10.9), (center_x, 0.36, 4.4), collection, materials["catalog_base"])
    column_labels = ["LIGHT M", "LIGHT E", "MID M", "MID E", "DEEP M", "DEEP E"]
    for column, label in enumerate(column_labels):
        x = 14.55 + column * 1.38
        add_text(label, (x, 0.22, 9.30), 0.115, collection, materials["label_light"])

    assets_by_key = {
        (asset["family_id"], asset["tone"], asset["finish"]): asset
        for asset in PAINT_ASSETS
    }
    for row, family in enumerate(PAINT_CATALOG["families"]):
        z = 8.72 - row * 0.91
        label = family["name_en"].upper().replace(" & ", " / ")
        add_text(label, (12.80, 0.22, z), 0.105, collection, materials["label_light"])
        column = 0
        for tone in PAINT_CATALOG["tones"]:
            for finish in PAINT_CATALOG["finishes"]:
                asset = assets_by_key[(family["id"], tone["id"], finish["id"])]
                x = 14.55 + column * 1.38
                panel = add_box(
...
def build_ceiling_catalog(collection: bpy.types.Collection, materials: dict[str, bpy.types.Material]) -> None:
    positions = [(14.0, 4.3), (18.0, 4.3), (22.0, 4.3), (16.0, 8.0), (20.0, 8.0)]
    for (center_x, center_y), preset in zip(positions, CEILING_ASSETS):
        add_ceiling_mockup(center_x, center_y, preset["id"], collection, materials)
...
def main() -> None:
    ...
    material_camera = add_camera("Camera_Material_Catalog", (18.0, -13.0, 3.35), (18.0, 0.25, 3.35), ortho_scale=14.6)
    paint_camera = add_camera("Camera_Paint_Catalog", (18.0, -15.0, 4.4), (18.0, 0.25, 4.4), ortho_scale=12.6)
    ceiling_camera = add_camera("Camera_Ceiling_Catalog", (18.0, -4.0, 7.8), (18.0, 6.0, 1.15), ortho_scale=14.2)
    ...
    # Complete wall-paint family, tone and finish matrix.
    set_collection_render(material_catalog, True)
